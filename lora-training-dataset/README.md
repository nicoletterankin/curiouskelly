...
This dataset contains 7 reference images of Kelly for training a character LoRA.
...
4. Upload all files from this folder (7 images + 7 .txt files)
5. Configure with settings above
6. Start training (~$15-25, 4-6 hours)

## Files in This Dataset

1. **4.jpeg** - Close-up portrait, big smile
2. **pray.jpeg** - Hands together, playful expression
3. **open-walk.jpeg** - Full body walking
4. **square-chair2.jpeg** - Seated, hand on heart
5. **our-girl.jpeg** - Seated, chin on hand
6. **open.png** - Close-up, contemplative
7. **close.jpeg** - Eyes closed, peaceful
