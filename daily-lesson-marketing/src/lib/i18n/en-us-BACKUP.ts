...
export const enUS: LocaleDictionary = {
  ...
  hero: {
    ...
    subheadline:
      'Curious Kelly blends story, science, and human warmth so your community keeps learning every single day.',
  ...
  testimonials: {
    title: 'Voices from our pilot partners',
    items: [
  ...
  features: {
    title: 'Why communities choose Curious Kelly',
    items: [
      {
      ...
      },
      {
        ...
        description: 'No ads, no dark patterns—your data stays encrypted and in your control.',
        icon: 'shield'
      },
      {
