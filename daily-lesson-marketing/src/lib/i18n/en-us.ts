...
export const enUS: LocaleDictionary = {
  ...
  leadForm: {
    ...
    successHeading: 'Welcome! You are all set.',
    successBody:
      'Check your email to start your first lesson. We are excited to have you!',
  ...
  testimonials: {
    ...
    items: [
      { quote: 'I look forward to my daily lesson with Kelly every morning. It is like coffee for my brain.', author: 'Sarah M.', role: 'Adult learner' },
