...
export function generateSitemap(site: string, pages: Array<{ path: string; lastmod?: string; changefreq?: string; priority?: number }>) {
...
export function generateSitemapRoutes(Astro: AstroGlobal) {
