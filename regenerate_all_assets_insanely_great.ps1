# Regenerate ALL Reinmaker Assets - Insanely Great Quality
# Including existing Kelly assets with updated character consistency system
...
Write-Host "REINMAKER ASSET REGENERATION - INSANELY GREAT QUALITY" -ForegroundColor Green
Write-Host "="*80 -ForegroundColor Green
Write-Host ""
...
Write-Host "  • Updated hair specification (soft cohesive waves, NOT frizzy/whispy/curly)" -ForegroundColor White
...
Write-Host "  • Proper separation of character vs wardrobe references" -ForegroundColor White
Write-Host ""
...
$backupDir = "assets\backup_all_regen_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
Write-Host "Step 2: Backing up existing assets..." -ForegroundColor Cyan
New-Item -ItemType Directory -Path $backupDir -Force | Out-Null
Write-Host "Backup location: $backupDir" -ForegroundColor Gray

# Backup existing Kelly assets
$assetsToBackup = @(
    "assets\player.png",
    "marketing\splash_intro.png",
    "marketing\itch-banner-1920x480.png"
)

foreach ($asset in $assetsToBackup) {
    if (Test-Path $asset) {
        $backupName = Split-Path -Leaf $asset
        Copy-Item $asset (Join-Path $backupDir "old_$backupName") -Force
        Write-Host "  Backed up: $asset" -ForegroundColor Gray
    }
}
Write-Host ""
...
Write-Host "REGENERATING KELLY ASSETS WITH UPDATED SYSTEM" -ForegroundColor Yellow
Write-Host "="*80 -ForegroundColor Yellow
Write-Host ""

# --- A1. Player: Kelly (Runner) - REGENERATE WITH UPDATED SYSTEM ---
Write-Host "[A1] Regenerating Player: Kelly (Runner)..." -ForegroundColor Cyan
...
# --- E1. Opening Splash - REGENERATE WITH UPDATED SYSTEM ---
Write-Host "[E1] Regenerating Opening Splash..." -ForegroundColor Cyan
...
# --- F1. Itch.io Banner - REGENERATE WITH UPDATED SYSTEM ---
Write-Host "[F1] Regenerating Itch.io Banner..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "="*80 -ForegroundColor Green
Write-Host "REGENERATION COMPLETE - INSANELY GREAT QUALITY" -ForegroundColor Green
Write-Host "="*80 -ForegroundColor Green
Write-Host ""
Write-Host "✅ Regenerated Kelly Assets (with updated systems):" -ForegroundColor Cyan
Write-Host "  [OK] A1. Player: Kelly (Runner)" -ForegroundColor Green
Write-Host "  [OK] E1. Opening Splash" -ForegroundColor Green
Write-Host "  [OK] F1. Itch.io Banner" -ForegroundColor Green
Write-Host ""
Write-Host "✅ Generated Missing Assets:" -ForegroundColor Cyan
Write-Host ""
Write-Host "Core Assets:" -ForegroundColor Yellow
Write-Host "  [OK] A3. Ground Stripe" -ForegroundColor Green
Write-Host "  [OK] B2. Ground Texture" -ForegroundColor Green
Write-Host "  [OK] C1. Logo (Square 600x600)" -ForegroundColor Green
Write-Host ""
Write-Host "Lore Collectibles:" -ForegroundColor Yellow
Write-Host "  [OK] D2. Tribe Banners (all 7)" -ForegroundColor Green
Write-Host ""
Write-Host "Stretch Goals:" -ForegroundColor Yellow
Write-Host "  [OK] G1. Coin Pickup" -ForegroundColor Green
Write-Host "  [OK] G2. Run Animation (3 frames)" -ForegroundColor Green
Write-Host ""
Write-Host "Quality Features Applied:" -ForegroundColor Cyan
Write-Host "  • Character consistency with $($charRefs.Count) character reference(s)" -ForegroundColor White
Write-Host "  • Updated hair specification (soft cohesive waves)" -ForegroundColor White
Write-Host "  • Vertex AI API with OAuth2 authentication" -ForegroundColor White
Write-Host "  • Enhanced prompts with complete character description" -ForegroundColor White
Write-Host "  • Proper character vs wardrobe reference separation" -ForegroundColor White
Write-Host ""
Write-Host "Backup Location: $backupDir" -ForegroundColor Gray
Write-Host ""
Write-Host "🎯 All assets regenerated with Insanely Great quality - Steve Jobs would be proud!" -ForegroundColor Green
Write-Host ""
