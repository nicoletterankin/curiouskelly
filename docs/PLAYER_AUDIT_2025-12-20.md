...
### Critical (1)
- **SECURITY DEFINER View**: `user_learning_journey` - runs as view creator, not user
...
1. ✅ Kelly Panel redesigned with Learn/Grow toggle, phases, reactions, comments
2. ✅ Header simplified to logo + time only
3. ✅ Choice cards polished (A/B badges hidden)
4. ✅ Side rail icons moved to header
5. ✅ Controls relocated to bottom-right
6. ✅ BYOK section added to Settings
7. ✅ Track column added to core_lessons
8. ✅ 7 Grow track starter lessons created
9. ✅ Lesson loader now supports track parameter
10. ✅ Phase sync in Kelly Panel
11. ✅ Visual loading from Visual Commons
