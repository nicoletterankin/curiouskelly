...
// Adjust path to point to the correct location from content-tools
const filePath = path.resolve(__dirname, '../backend/config/lessons/music-human-culture-dna.json');
