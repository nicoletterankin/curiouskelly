    ...
    this.overlay.innerHTML = `
      <div class="earn-container">
        ...
        <div class="earn-link-section">
          <label class="earn-label">Referral Link (LIFETIME attribution)</label>
          ...
          <p class="earn-link-note">
            When someone uses this link, credit is assigned <strong>forever</strong> — even if they sign up years later.
          </p>
        </div>
        ...
        <div class="earn-under-13" id="earn-under-13" style="display: none;">
          ...
          <p>Kids under 13 need a parent or guardian to set up Share & Earn. It's the law to keep everyone safe!</p>
          <p class="earn-parent-note">A parent can link this account to theirs, and they'll manage any earnings until the learner is older.</p>
        ...
        <div class="earn-minor" id="earn-minor" style="display: none;">
          <div class="minor-notice">
            ...
            <div class="minor-text">
              <strong>Earnings are being saved!</strong>
              <p>Learners under 18 have earnings held until their 18th birthday. 
              If a parent is linked to the account, they can claim them earlier.</p>
            </div>
          </div>
