class ConvBlock(Module):
  ...
  __buffers__ = []
  training : bool
  bn1 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_61.BatchNorm2d
  conv1 : __torch__.torch.nn.modules.conv.___torch_mangle_62.Conv2d
  bn2 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_63.BatchNorm2d
  conv2 : __torch__.torch.nn.modules.conv.___torch_mangle_64.Conv2d
  bn3 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_65.BatchNorm2d
  conv3 : __torch__.torch.nn.modules.conv.___torch_mangle_66.Conv2d
  def forward(self: __torch__.face_alignment.models.fan.___torch_mangle_67.ConvBlock,
    input: Tensor) -> Tensor:
    _0 = self.conv3
    _1 = self.bn3
    _2 = self.conv2
