class ConvBlock(Module):
  ...
  bn3 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_12.BatchNorm2d
  conv3 : __torch__.torch.nn.modules.conv.___torch_mangle_13.Conv2d
  def forward(self: __torch__.face_alignment.models.fan.___torch_mangle_14.ConvBlock,
    input: Tensor) -> Tensor:
    _0 = self.conv3
    _1 = self.bn3
    _2 = self.conv2
